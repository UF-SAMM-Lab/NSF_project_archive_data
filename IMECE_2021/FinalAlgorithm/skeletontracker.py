...
def default_log_dir():
    if platform.system() == "Windows":
         return 'C:\\Users\\Gabe\\AppData\\Local\\Cubemos\\SkeletonTracking\\bin'
...
def default_license_dir():
    if platform.system() == "Windows":
        return 'C:\\Users\\Gabe\\AppData\\Local\\Cubemos\\SkeletonTracking\\license'
    elif platform.system() == "Linux":
...
class skeletontracker:
    def __init__(self, cloud_tracking_api_key = ""):
        ...
        sdk_path = 'C:\\Program Files\\Cubemos\\SkeletonTracking'
        model_path = sdk_path + '\\models\\skeleton-tracking\\fp32\\skeleton-tracking.cubemos'
        

        # Initialise the logging
        #initialise_logging('C:\\Program Files\\Cubemos\\SkeletonTrackingSDK\\bin') 
